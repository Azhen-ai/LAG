...
episode_rewards = 0
ego_run_dir = "C:/Users/avic/Desktop/lag--old/scripts/results/SingleCombat/1v1/NoWeapon/Selfplay/ppo/v1/wandb/run-20250305_150841-9bdk22m8/files"
enm_run_dir = "C:/Users/avic/Desktop/lag--old/scripts/results/SingleCombat/1v1/NoWeapon/Selfplay/ppo/v1/wandb/run-20250305_150841-9bdk22m8/files"
...
while True:
    ...
    # print(f"Ego Actions: {ego_actions}")
    # print(f"Enm Actions: {enm_actions}")
    # print(f"action_space: {env.action_space.shape}")
    enm_obs =  obs[num_agents // 2:, ...]
    ego_obs =  obs[:num_agents // 2, ...]
    # print(f"enm_obs:{enm_obs}")
