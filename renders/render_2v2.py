...
# 获取当前脚本的绝对路径（render_2v2.py）
current_script_path = os.path.abspath(__file__)
# 找到项目根目录（假设 CloseAirCombat-master 是根目录）
...
enm_policy_index = 0
episode_rewards = 0
ego_run_dir = "D:/CloseAirCombat/scripts/results/MultipleCombat/2v2/NoWeapon/HierarchySelfplay/mappo/HierarchySelfplay/wandb/latest-run/files"
enm_run_dir = "D:/CloseAirCombat/scripts/results/MultipleCombat/2v2/NoWeapon/HierarchySelfplay/mappo/HierarchySelfplay/wandb/latest-run/files"
